  ...
  static async getStats(lunchId) {
    const [stats] = await pool.execute(`
      SELECT 
        ...
        AVG(pay) as avg_pay,
        SUM(CASE WHEN cook_soup = 'yes' THEN 1 ELSE 0 END) as cook_soup_yes,
        SUM(CASE WHEN cook_soup = 'no' THEN 1 ELSE 0 END) as cook_soup_no,
        SUM(CASE WHEN cook_food = 'yes' THEN 1 ELSE 0 END) as cook_food_yes,
        SUM(CASE WHEN cook_food = 'no' THEN 1 ELSE 0 END) as cook_food_no,
        SUM(CASE WHEN cook_dessert = 'yes' THEN 1 ELSE 0 END) as cook_dessert_yes,
        SUM(CASE WHEN cook_dessert = 'no' THEN 1 ELSE 0 END) as cook_dessert_no,
